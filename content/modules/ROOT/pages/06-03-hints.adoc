...
* Maybe the client itself is unable to deliver the amount of parralelism required. How could we change that? What tools mayb be better suited than raw python coding?
*
====
