...
* The salvaged code and data have been stored under folder link:https://github.com/rh-aiservices-bu/ai-mazing-race/tree/main/lab-materials/03[lab-materials/03^].
...
* Implement an automated solution for the notebook to run daily, at 02:00 AM exactly, on Spanish time (CET)
