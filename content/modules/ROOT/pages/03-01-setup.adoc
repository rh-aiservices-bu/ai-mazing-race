...
* A brand-new telescope called CAIx at the GranTeCan observatory (one of the link:https://en.wikipedia.org/wiki/Gran_Telescopio_Canarias[largest in the world]) has recently been launched.
...
* Implement an automated solution for the notebook to daily, at 02:00 AM exactly, on spanish time
