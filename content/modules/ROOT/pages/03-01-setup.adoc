...
* A brand-new telescope called CAIx at the GranTeCan observatory (one of the [largest in the world](https://en.wikipedia.org/wiki/Gran_Telescopio_Canarias)) has been launched.
...
** Only one repository belonging to a former Data Scientist was salvaged from our[ Git repository](https://github.com/rh-aiservices-bu/ai-mazing-race/tree/main/lab-materials/03), but it contains multiple errors, and the Data Scientist left the Agency four months ago.
...
* Implement an automated solution for the notebook to run every 24 hours, every day of the week.
